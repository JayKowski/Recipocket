        ...
        <div className="meal-preview">
          ...
          <div className="flex-cont">
            ...
            <div className="preview-deets">
              ...
              <Link to={`/meal/${this.props.meal.idMeal}`}><button className="more-details">See More</button></Link>
            </div>
          </div>
        </div>
      );
      ...
      return (
        <div className="meal-preview small-preview">
          ...
          <div className="one-preview">
            ...
            <Link to={`/meal/${this.props.meals.idMeal}`}><button className="see-more">See More</button></Link>
          </div>
        </div>
      );
    }
